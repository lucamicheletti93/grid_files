...
ALIEN_PATH="PbPb2015_TRF/LHC15o/muon_calo_pass1"
...
LOCAL_PATH="/home/luca/data_storage/PbPb2015_TRF"
COUNTER=0
RUN_TO_ADD=true
...
while IFS=FILE_TERMINATED_RUNS read LINE; do
    if [ $(find "$LOCAL_PATH" -name "Tree_$LINE.root") ]; then 
        echo "rmdir /alice/cern.ch/user/l/lmichele/PbPb2015_TRF/LHC15o/muon_calo_pass1/$LINE"
    fi
done < "$FILE_TERMINATED_RUNS"
