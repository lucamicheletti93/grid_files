...
//                       TString DataPattern="*muon_calo_pass1/AOD197/*/AliAOD.Muons.root",             // Alternative = String DataPattern="*muon_calo_pass2/AOD/*/AliAOD.root",
  ...
  if(usePhysicsSelection) taskTree -> SelectCollisionCandidates(AliVEvent::kMuonUnlikeLowPt7 | AliVEvent::kMuonLikeLowPt7 | AliVEvent::kMuonSingleLowPt7 | AliVEvent::kMuonSingleHighPt7  | AliVEvent::kINT7inMUON  | AliVEvent::kINT7 | AliVEvent::kMuonUnlikePB | AliVEvent::kMuonLikePB | AliVEvent::kMUSPB | AliVEvent::kMB);
