    ...
    if(mu0 -> IsMuonTrack()){
      for(int j = i+1;j < ntracks;j++){
        ...
        if(mu1 -> IsMuonTrack()){
          ...
          cout << "Beam energy = " << fBeamEnergy << endl;
                  ...
                  if(fIsPhysSelected){                                                    // PS added to see the effet
                    if(TriggerSelected_CINT7){
                      ...
                      if(DimuPt > 0 && DimuPt < 50){
                        ...
                        if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_25y4"))) -> Fill(Pt_Mu0);}
                        if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_25y4"))) -> Fill(Pt_Mu1);}

                        // Filling Y bins
                        if(DimuY > -3.0 && DimuY < -2.5){
                          if(Match_Mu0 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_25y3"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu1 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_25y3"))) -> Fill(Pt_Mu1);}

                          if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_25y3"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_25y3"))) -> Fill(Pt_Mu1);}
                        }

                        if(DimuY > -3.5 && DimuY < -3.0){
                          if(Match_Mu0 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_3y35"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu1 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_3y35"))) -> Fill(Pt_Mu1);}

                          if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_3y35"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_3y35"))) -> Fill(Pt_Mu1);}
                        }

                        if(DimuY > -4 && DimuY < -3.5){
                          if(Match_Mu0 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_35y4"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu1 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_35y4"))) -> Fill(Pt_Mu1);}

                          if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_35y4"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_35y4"))) -> Fill(Pt_Mu1);}
                        }

                        // Filling Eta bins
                        if(Eta_Mu0 > -3.0 && Eta_Mu0 < -2.5){
                          if(Match_Mu0 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_25eta3"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_25eta3"))) -> Fill(Pt_Mu0);}
                        }

                        if(Eta_Mu1 > -3.0 && Eta_Mu1 < -2.5){
                          if(Match_Mu1 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_25eta3"))) -> Fill(Pt_Mu1);}
                          if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_25eta3"))) -> Fill(Pt_Mu1);}
                        }

                        if(Eta_Mu0 > -3.5 && Eta_Mu0 < -3.0){
                          if(Match_Mu0 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_3eta35"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_3eta35"))) -> Fill(Pt_Mu0);}
                        }

                        if(Eta_Mu1 > -3.5 && Eta_Mu1 < -3.0){
                          if(Match_Mu1 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_3eta35"))) -> Fill(Pt_Mu1);}
                          if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_3eta35"))) -> Fill(Pt_Mu1);}
                        }

                        if(Eta_Mu0 > -4.0 && Eta_Mu0 < -3.5){
                          if(Match_Mu0 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_35eta4"))) -> Fill(Pt_Mu0);}
                          if(Match_Mu0 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_35eta4"))) -> Fill(Pt_Mu0);}
                        }

                        if(Eta_Mu1 > -4.0 && Eta_Mu1 < -3.5){
                          if(Match_Mu1 >= 1){((TH1D*)(fOutput -> FindObject("histAllPtDM_35eta4"))) -> Fill(Pt_Mu1);}
                          if(Match_Mu1 >= 2){((TH1D*)(fOutput -> FindObject("histLowPtDM_35eta4"))) -> Fill(Pt_Mu1);}
                        }
                      }
                    }
                  }
